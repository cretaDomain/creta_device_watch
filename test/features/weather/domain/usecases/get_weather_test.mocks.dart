...
// in creta_device_watch/test/features/weather/domain/usecases/get_weather_test.dart.
...
class MockWeatherRepository extends _i1.Mock implements _i3.WeatherRepository {
  ...
  @override
  _i4.Future<_i2.Weather> getWeather(String? cityName) =>
      (super.noSuchMethod(
            Invocation.method(#getWeather, [cityName]),
            returnValue: _i4.Future<_i2.Weather>.value(
              _FakeWeather_0(this, Invocation.method(#getWeather, [cityName])),
            ),
          )
